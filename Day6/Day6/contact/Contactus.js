  ...
  <div class="responsive-container-block big-container">
    <div class="responsive-container-block container">
      <div class="responsive-cell-block wk-mobile-12 wk-desk-5 wk-tab-10 wk-ipadp-5" id="ih6s">
        <p class="text-blk section-head"><b>Any Queries?</b>
        </p>
      ...
      <div class="responsive-cell-block wk-ipadp-6 wk-mobile-12 wk-desk-5 wk-tab-9" id="i6df">
        <div class="form-wrapper">
          <input class="input input-element" name="Name" placeholder="Name"></input>
          <input class="input input-element" name="Contact Number" placeholder="Contact Number"></input>
          <input class="input input-element" name="Email" placeholder="Email"></input>
          <textarea class="textinput input-element" placeholder="Message"></textarea>
          <button className="logb1">SEND</button>
